...
import logging
from typing import Any, Callable, Coroutine, TypeVar, ParamSpec, Optional
...
def handle_db_errors(fn: Callable[P, Coroutine[Any, Any, R]]) -> Callable[P, Coroutine[Any, Any, R]]:
    ...
    async def wrapper(*args: P.args, **kwargs: P.kwargs) -> R:
        try:
            ...
            raise HTTPException(status_code=503, detail="Database unavailable, try again later") from e
